...
export default function PhotosUploader({addedPhotos,onChange}) {
  ...
  async function addPhotoByLink(ev) {
    ev.preventDefault();
    const {data:filename} = await axios.post('/api/places/upload-by-link', {link: photoLink});
    onChange(prev => {
  ...
  function uploadPhoto(ev) {
    ...
    axios.post('/api/places/upload', data, {
      ...
      toast.error("Something went wrong while uploading your picture. Please try again.");
      console.log(e);
    })
  }
